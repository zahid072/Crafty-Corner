    ...
    <div className="bg-[#282727] ">
      ...
      <footer className="footer p-10  text-white">
        <nav>
          ...
          <a className="link link-hover"><p className=" text-xl flex items-center gap-3">
          ...
          <span className="text-xl">zahidhasan@gmail.com</span>
        </p></a>
          <a className="link link-hover"><p className=" text-xl flex items-center gap-3">
          <MdOutlineMailOutline className="text-emerald-500 text-center text-xl " />
          <span className="text-xl">+88 9554852545</span>
        </p></a>
        </nav>
        <nav>
      ...
      <div className="py-5 border-y px-10 flex md:flex-row flex-col items-center text-white justify-between">
          <h1 className="text-2xl font-semibold flex items-center gap-2"><IoIosMailOpen className="text-emerald-500 text-center text-2xl"/> NEWSLETTER</h1>
