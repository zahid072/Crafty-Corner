    ...
    <div className="bg-[#282727] ">
        ...
        <nav>
          ...
          <a className="link link-hover">
            <p className=" text-xl flex items-center gap-3">
              <FaLocationDot className="text-[#5C8392] text-center text-xl " />
              <span className="text-xl">The Grove, Los Angeles, CA</span>
            </p>
          </a>
          <a className="link link-hover">
            <p className=" text-xl flex items-center gap-3">
              <BsTelephone className="text-[#5C8392] text-center text-xl " />
      ...
      <footer className="footer px-10 py-4 border-t flex justify-end bg-[#373737] text-white border-base-300">
        <aside className="items-end grid-flow-col">
          ...
          <p>All rights reserved. © 2024 Crafty Corner.</p>
        </aside>
      </footer>
    </div>
  );
